...
import CircleCloseSvg from '../../Assets/Svg/Common/CircleCloseSvg'
...
export const CountryPicker = ({
  ...
  //  console.log('10555','show',show)
    React.useEffect(() => {
        if (show) {
           // console.log(10808,'showModal',showModal)
            setShowModal(true);
        } else {
            closeModal();
        }
    ...
    const closeModal = () => {
      //  console.log(19500,'showModal',showModal)
        Animated.timing(animationDriver, {
            toValue: 0,
            duration: 400,
            useNativeDriver: true,
 ...
 //  console.log(22511,'showModal',showModal)
    return (
        <Modal
            animationType="fade"
            transparent={true}
